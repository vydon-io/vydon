CREATE TABLE IF NOT EXISTS vydon_api.slack_oauth_connections (
...
CREATE INDEX IF NOT EXISTS idx_slack_oauth_connections_account_id
  ON vydon_api.slack_oauth_connections(account_id);

CREATE TRIGGER update_vydon_api_slack_oauth_connections_updated_at
  BEFORE UPDATE ON vydon_api.slack_oauth_connections
  FOR EACH ROW
  EXECUTE FUNCTION update_updated_at_column();

COMMENT ON TABLE vydon_api.slack_oauth_connections
