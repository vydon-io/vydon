...
This database can be configured in Vydon, and the root+client certs can be added to the connection configuration to further test out a database that uses SSL certificates.
