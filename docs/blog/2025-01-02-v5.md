...
5. Introduced a new Vydon data structured for reading/writing data to s3
6. Updated the Typescript SDK to use the Connection V2 api
7. Object storage/metrics/logs have been moved to the Enterprise license for self-hosted Vydon
