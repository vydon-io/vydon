...
> Screenshot pending re-hosting (new sync job define step).
...
> Screenshot pending re-hosting (new sync job connect step).
...
> Screenshot pending re-hosting (sync job subset step).
