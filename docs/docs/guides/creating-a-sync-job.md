...
![job-define](https://assets.vydon.io/vydon/docs/new-sync-job-definition.png)
...
![job-connect](https://assets.vydon.io/vydon/docs/new-sync-job-connections.png)
...
![job-subset](https://assets.vydon.io/vydon/docs/new-sync-job-subset.png)
