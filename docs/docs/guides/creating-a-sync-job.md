...
![jobs](https://assets.vydon-io.com/vydon/docs/jobs-page.png)
...
![job-define](https://assets.vydon-io.com/vydon/docs/new-sync-job-definition.png)
...
![job-connect](https://assets.vydon-io.com/vydon/docs/new-sync-job-connections.png)

5. Next is the Schema page. Here you can select how you want to transform your tables and columns with [**Transformers**](/core-concepts#transformers). There are a number of [transformers](/transformers/system) that Vydon ships with out of the box or you can create your own custom transformer.
...
![job-subset](https://assets.vydon-io.com/vydon/docs/new-sync-job-subset.png)
