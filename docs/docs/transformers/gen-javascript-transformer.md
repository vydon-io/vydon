...
const newValue = vydon.transformCharacterScramble(value, {
	userProvidedRegex: "", 
	seed: 1, 
});
...
const newValue = vydon.transformE164PhoneNumber(value, {
...
const newValue = vydon.transformEmail(value, {
	preserveLength: false,
...
const newValue = vydon.transformFirstName(value, {
	maxLength: 100,
	preserveLength: false,
	seed: 1, 
});
...
const newValue = vydon.transformFloat64(value, {
...
const newValue = vydon.transformFullName(value, {
	maxLength: 100,
	preserveLength: false,
	seed: 1, 
});
...
const newValue = vydon.transformInt64(value, {
	randomizationRangeMin: 1,
	randomizationRangeMax: 10000,
	seed: 1, 
});
...
const newValue = vydon.transformInt64PhoneNumber(value, {
	preserveLength: false,
	seed: 1, 
});
...
const newValue = vydon.transformLastName(value, {
	maxLength: 100,
	preserveLength: false,
	seed: 1, 
});
...
const newValue = vydon.transformString(value, {
	preserveLength: false,
	minLength: 1,
	maxLength: 100,
	seed: 1, 
...
const newValue = vydon.transformStringPhoneNumber(value, {
	preserveLength: false,
	maxLength: 100,
	seed: 1, 
});
...
const newValue = vydon.transformUuid(value, {
	seed: 1, 
});
...
const newValue = vydon.generateBool({
	seed: 1, 
});
...
const newValue = vydon.generateBusinessName({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = vydon.generateCardNumber({
	validLuhn: false,
	seed: 1, 
});
...
const newValue = vydon.generateCategorical({
...
const newValue = vydon.generateCity({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = vydon.generateCountry({
...
const newValue = vydon.generateEmail({
	maxLength: 100000,
	emailType: 'uuidv4',
	seed: 1, 
});
...
const newValue = vydon.generateFirstName({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = vydon.generateFloat64({
	randomizeSign: false,
	min: 1,
	max: 10000,
	precision: 1, 
...
const newValue = vydon.generateFullAddress({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = vydon.generateFullName({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = vydon.generateGender({
	abbreviate: false,
	maxLength: 100,
	seed: 1, 
});
...
const newValue = vydon.generateInt64({
	randomizeSign: false,
	min: 1,
	max: 10000,
	seed: 1, 
...
const newValue = vydon.generateInt64PhoneNumber({
	seed: 1, 
});
...
const newValue = vydon.generateInternationalPhoneNumber({
	min: 9,
	max: 15,
	seed: 1, 
});
...
const newValue = vydon.generateLastName({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = vydon.generateRandomString({
	min: 1,
	max: 100,
	seed: 1, 
});
...
const newValue = vydon.generateSHA256Hash({});
...
const newValue = vydon.generateSSN({
	seed: 1, 
});
...
const newValue = vydon.generateState({
	generateFullName: false,
	seed: 1, 
});
...
const newValue = vydon.generateStreetAddress({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = vydon.generateStringPhoneNumber({
	min: 9,
	max: 15,
	seed: 1, 
});
...
const newValue = vydon.generateUnixTimestamp({
	seed: 1, 
});
...
const newValue = vydon.generateUsername({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = vydon.generateUTCTimestamp({
	seed: 1, 
});
...
const newValue = vydon.generateUUID({
	includeHyphens: true,
});
...
const newValue = vydon.generateZipcode({
	seed: 1, 
});
