---
title: Introduction
description: Learn about Vydon transformers and how you can use them to anonymize data and generate synthetic data
id: introduction
hide_title: false
...
Transformers are defined in the job workflow and are applied to every piece of data in the column they are assigned. Vydon ships with a comprehensive catalog of pre-defined transformers covering common data types — see the [system transformers reference](/transformers/system) for the full list.

> Screenshot pending re-hosting. Open the Vydon UI under Transformers to browse the gallery.

## Transformer Types

There are two types of transformers:

1. System Transformers - Pre-built and configured transformers that automatically come with Vydon out of the box. These cannot be deleted but they can be cloned.
