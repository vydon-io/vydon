...
Transformers are defined in the job workflow and are applied to every piece of data in the column they are assigned. Vydon ships with over 40 pre-defined transformers that make it fast and easy to get started.
