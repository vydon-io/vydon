...
description: Learn about Vydon's user defined transformers and how you can create one to implement custom anonymization logic
id: user-defined
hide_title: false
...
![udt](https://assets.vydon-io.com/vydon/docs/user-defined-transformers-home.png)
...
![udt](https://assets.vydon-io.com/vydon/docs/udt-new.png)
...
![udt](https://assets.vydon-io.com/vydon/docs/udt-new-float.png)
...
![udt](https://assets.vydon-io.com/vydon/docs/udt-new-float-home-page.png)
