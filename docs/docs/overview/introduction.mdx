---
title: Introduction
description: Vydon is an open-source, developer-first way to anonymize PII, generate synthetic data and sync environments for better testing, debugging and developer experience
id: intro
hide_title: false
slug: /
---
...
# Welcome to the Vydon Docs

Vydon is an open-source, developer-first way to anonymize PII, generate synthetic data and sync environments for better
testing, debugging and developer experience.

<ThemedImage
  alt="Vydon header"
  sources={{
    light: 'https://assets.vydon.com/vydon/docs/vydon-header.svg',
    dark: 'https://assets.vydon.com/vydon/docs/vydon-header-dark.svg',
  }}
/>

## Core Features

Vydon has four core features that deliver value to developers and engineering teams. Click on each one below to learn more.
...
Vydon can be used in many different ways to support different use-cases. Check out the most common use-cases below.
...
Once you're ready to deploy Vydon, check out our Deployment guide to see the available deployment options.

<CustomCard
  title="Deploy"
  description="Learn how to deploy Vydon using Docker Compose or Kubernetes. "
  link="/deploy/introduction"
  icon={<PiRocketLaunchLight />}
/>

## Contributing to Vydon

We love contributors and are happy to accept PRs. The best way to contribute to Vydon is to go ahead and try out it. If you find something is not right, you can report an issue [here](https://github.com/vydon/vydon/issues/new?assignees=&labels=bug&template=bug_report.md).
