...
func (i *Interval) GetVersion() Version {
	return i.Vydon.Version
}

func NewIntervalFromPgx(value any, opts ...VydonTypeOption) (*Interval, error) {
...
func NewInterval(opts ...VydonTypeOption) (*Interval, error) {
	interval := &Interval{}
	interval.Vydon.TypeId = VydonIntervalId
