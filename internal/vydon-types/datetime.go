...
func (dt *VydonDateTime) setVersion(v Version) {
	dt.Vydon.Version = v
}

func (dt *VydonDateTime) GetVersion() Version {
	return dt.Vydon.Version
}

func (dt *VydonDateTime) ScanJson(value any) error {
	return dt.JsonScanner.ScanJson(value, dt)
}

func (dt *VydonDateTime) ValueJson() (any, error) {
	return dt.JsonScanner.ValueJson(dt)
}

func (dt *VydonDateTime) ScanPgx(value any) error {
	if value == nil {
		return nil
	}
...
func (dt *VydonDateTime) ValuePgx() (any, error) {
	year := dt.Year
	if dt.IsBC {
...
func (dt *VydonDateTime) handlePgxBCDate() (any, error) {
...
func (dt *VydonDateTime) ScanMysql(value any) error {
	if value == nil {
		return nil
	}
...
func (dt *VydonDateTime) ValueMysql() (any, error) {
	year := dt.Year
	if dt.IsBC {
...
func (dt *VydonDateTime) ScanMssql(value any) error {
	if value == nil {
		return nil
	}
...
func (dt *VydonDateTime) ValueMssql() (any, error) {
	year := dt.Year
...
func NewDateTimeFromMysql(value any, opts ...VydonTypeOption) (*VydonDateTime, error) {
...
func NewDateTimeFromMssql(value any, opts ...VydonTypeOption) (*VydonDateTime, error) {
	dt, err := NewDateTime(opts...)
	if err != nil {
		return nil, err
	}
...
func NewDateTimeFromPgx(value any, opts ...VydonTypeOption) (*VydonDateTime, error) {
	dt, err := NewDateTime(opts...)
	if err != nil {
		return nil, err
	}
...
func NewDateTime(opts ...VydonTypeOption) (*VydonDateTime, error) {
	dt := &VydonDateTime{}
	dt.Vydon.TypeId = VydonDateTimeId
