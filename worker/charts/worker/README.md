...
| image.repository | string | `"ghcr.io/vydon-io/vydon/worker"` | The default image repository |
...
| vydon.apiKey | string | `nil` | Only required if running the backend in auth-mode |
| vydon.url | string | `"http://vydon-api"` | The url to the Neoysnc API instance |
