...
func Test_Sync(t *testing.T) {
	...
	conndataclient := vydonApi.OSSUnauthenticatedLicensedClients.ConnectionData()
	...
	s3Conn := tcvydonapi.CreateS3Connection(
		ctx,
		t,
		connclient,
		accountId,
	...
	t.Run("postgres", func(t *testing.T) {
		...
		t.Run("S3_end_to_end", func(t *testing.T) {
			...
			vydonApi.MockTemporalForCreateJob("cli-test-sync")
			...
			t.Run("Postgres_to_S3", func(t *testing.T) {
				testworkflow := tcworkflow.NewTestDataSyncWorkflowEnv(t, vydonApi, dbManagers)
